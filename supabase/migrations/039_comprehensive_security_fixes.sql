-- ============================================================
-- MIGRATION 039: Comprehensive Security Fixes
-- Date: 2026-07-10
...
-- NOTE: spatial_ref_sys is a PostGIS system table owned by
--       rds_superuser. Enable RLS manually via Supabase Dashboard:
--       Database → Tables → spatial_ref_sys → Enable RLS
-- ============================================================
