-- ============================================================
-- Migration 041 — Seed zones (données géographiques initiales)
-- Fix: ce fichier remplace 039_seed_zones.sql qui avait
--      un conflit de numérotation avec 2 autres fichiers 039.
-- Zones couvrant Algérie, France, Maroc, Tunisie
-- ============================================================
