...
class UserProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Refresh counts when follow state changes
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          profileState.profile?.displayName ?? 'Profil',
        ),
      ),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      FilledButton(
                        onPressed: () =>
                            ref.read(profileProvider(userId).notifier).load(),
                    ...
                    slivers: [
                          ...
                          child: Column(
                            children: [
                              ...
                              XpLevelBadge(
                                ...
                                nextXp:
                                    gamification.userLevel?.nextLevelXp ?? 100,
                                progressPercent:
                                    gamification.userLevel?.progressPercent ??
                                        0,
                              ),
                                      ...
                                      child: Consumer(
                                        builder: (context, ref, _) {
                                          final blockedIds = ref.watch(
                                              blockProvider.select(
                                                  (s) => s.blockedUsers));
                                          final isBlocked =
                                              blockedIds.contains(userId);
                                          final isBlockLoading = ref
                                              .watch(blockProvider)
                                              .isLoading;
                      ...
                      SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) =>
                              PostCard(post: profileState.posts[index]),
